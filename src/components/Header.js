...
const Header = () => {
  ...
  return (
    <>
      <Navbar bg="dark" variant="dark" style={{padding:"15px",position:"sticky",top:0,left:0,zIndex:500}}>
        <Container>
      ...
      >
        {
          ...
          <div className="card_details d-flex justify-content-center align-items-center " style={{width:"24rem", padding:10,position:"relative"}}>
            ...
            <img src="https://c.tenor.com/Jwa4vbfY390AAAAM/going-shopping-shopping.gif" alt="" style={{width:"6rem",padding:5}}/>
        </div>
        }
